  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        <Heading
          title="Generative AI Images made for Creators."
          text="AImage unlocks the potential of AI-powered applications"
        />
          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                AImage unlocks the potential of AI-powered applications
              </p>
              <ul className="body-2">
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2 ">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/10 to-n-8/90 lg:p-15">
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  AImage for Photo Editing and Generative AI images. Try it now!
                </p>
              </div>
