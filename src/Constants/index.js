...
export const roadmap = [
  {
    ...
    text: "Enable to generate beautiful AI based images with sites like unplash and more.",
    date: "Jan 2024",
    status: "done",
    imageUrl: roadmap1,
    colorful: true,
  },
  {
    ...
    text: "Tools for removing the background images and removal of object which can attract the youth and plays imp role in editing.",
    date: "Feb 2024",
    status: "progress",
    imageUrl: roadmap2,
  },
  {
    id: "2",
    title: "Generative AI",
    text: "Allow users to customize the photo appearance and behavior, making it more engaging and fun to uphold through.",
    date: "March 2024",
    status: "done",
    imageUrl: roadmap3,
  },
  {
    id: "3",
    title: "Integration with Enhancement",
    text: "Allow users to use as many editing tools they want to enhance there images.",
    date: "April 2024",
    status: "progress",
    imageUrl: roadmap4,
  },
...
export const benefits = [
  {
    id: "0",
    title: "Ask anything",
    text: "Lets users quickly find images to their reference without having to search through multiple sources.",
  ...
  },
  {
    ...
    text: "Connect with the AImage from anywhere, on any device, making it more accessible and convenient.",
